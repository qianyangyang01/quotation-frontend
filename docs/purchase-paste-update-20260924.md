...
- 初始基线：`2f016165c734c354ca9879193e21f968dcf69291`。用户随后授权等待其他任务完成后统一提交部署，已只读核对实时生产 manifest 为 `quotation-2026.09.24-17` / `1ef01db14d055f29b1e05717f0ef30a0b00419e2`。
- 功能提交 `a4319fd`，已合并上述最新生产基线，保留模板覆盖保护、同渠道免审及完整/隐藏报价单选择。准备发布为 `quotation-2026.09.24-18`，最终部署状态以该版本发布验收记录为准。原桌面工作区及其他任务的修改未改动，本功能无新增数据库迁移。
