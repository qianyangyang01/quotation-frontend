...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/quotation/suppliers', name: 'quotation-suppliers', component: () => import('@/views/MasterDataView.vue'), props: { mode: 'suppliers' }, meta: { title: '供应商管理', permission: 'purchase' } },
    { path: '/quotation/customers', name: 'quotation-customers', component: () => import('@/views/MasterDataView.vue'), props: { mode: 'customers' }, meta: { title: '客户管理', permission: 'finance' } },
