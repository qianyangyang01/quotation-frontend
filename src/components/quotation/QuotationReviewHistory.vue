...
const labels:Record<string,string>={withdraw:'撤回报价，原审核失效',claim:'开始审核',cancel:'取消审核',release:'管理员解除占用',complete:'审核完成','content-changed':'报价变更，需重新核对','legacy-review':'历史审核结果'}
</script>
<template>
