...
export function createPurchaseImportJob(file:File,onProgress?:(progress:UploadProgress)=>void){const form=new FormData();form.append('file',file);return uploadForm<PurchaseImportJob>('/purchase-imports/jobs',form,onProgress)}
