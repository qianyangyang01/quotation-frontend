...
function startEditing() { if (busy.value || !version.value?.rows) return; editSnapshot.value = clonePriceRows(version.value.rows); editingRows.value = true; detailTab.value = 'rows'; detailPage.value = 0; resetPublishFeedback() }
