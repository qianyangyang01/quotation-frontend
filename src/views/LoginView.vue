...
<template>
  <main class="login-page">
    ...
    <svg class="live-network" viewBox="0 0 1920 1080" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
      <defs>
        <linearGradient id="routeGlow" x1="0" y1="0" x2="1" y2="0"><stop offset="0" stop-color="#ff7a00" stop-opacity="0"/><stop offset=".5" stop-color="#ffae35" stop-opacity=".9"/><stop offset="1" stop-color="#ff7a00" stop-opacity="0"/></linearGradient>
      ...
      <path id="flight-a" class="live-route route-a" d="M80 590 C390 210 830 165 1280 410"/>
      <path id="flight-b" class="live-route route-b" d="M220 760 C590 320 1040 245 1520 550"/>
      <path id="flight-c" class="live-route route-c" d="M530 620 C850 320 1190 335 1710 690"/>
      <path id="flight-d" class="live-route route-d" d="M170 430 C620 610 890 655 1370 470"/>
      <circle class="route-dot" r="4"><animateMotion dur="7s" repeatCount="indefinite"><mpath href="#flight-a"/></animateMotion></circle>
      <circle class="route-dot" r="3.5"><animateMotion dur="9s" begin="-3s" repeatCount="indefinite"><mpath href="#flight-b"/></animateMotion></circle>
      <circle class="route-dot" r="4"><animateMotion dur="8s" begin="-5s" repeatCount="indefinite"><mpath href="#flight-c"/></animateMotion></circle>
      <circle class="route-dot" r="3"><animateMotion dur="10s" begin="-2s" repeatCount="indefinite"><mpath href="#flight-d"/></animateMotion></circle>
    </svg>
...
.login-page{background-color:#061526;background-image:linear-gradient(90deg,rgba(3,15,28,.08) 0%,rgba(3,15,28,.02) 54%,rgba(2,12,24,.22) 100%),url("@/assets/login-world-network-bg-v2.png");background-position:center;background-size:cover}
...
.login-page{background-image:linear-gradient(90deg,rgba(3,15,28,.035) 0%,rgba(3,15,28,.01) 55%,rgba(2,12,24,.1) 100%),url("@/assets/login-world-network-bg-v2.png")}
.live-network{position:absolute;z-index:1;inset:0;width:100%;height:100%;overflow:visible;pointer-events:none;mix-blend-mode:screen;opacity:.68}
.live-route{fill:none;stroke:url(#routeGlow);stroke-width:1.45;stroke-linecap:round;stroke-dasharray:10 18;filter:drop-shadow(0 0 5px rgba(255,139,16,.72));animation:routeFlow 9s linear infinite}
.route-b{animation-duration:12s;animation-direction:reverse;opacity:.72}.route-c{animation-duration:10s;opacity:.6}.route-d{animation-duration:15s;animation-direction:reverse;opacity:.48}.route-dot{fill:#ffd18a;filter:url(#dotGlow);opacity:.95}
...
@keyframes routeFlow{to{stroke-dashoffset:-224}}
@media(prefers-reduced-motion:reduce){.live-route{animation:none}.route-dot{display:none}}
</style>
