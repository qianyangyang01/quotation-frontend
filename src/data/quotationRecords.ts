...
export type QuotationReviewState = Pick<QuotationRecord, 'id' | '_version' | '_reviewVersion' | 'financeReviewClaimedAccount' | 'financeReviewClaimedBy' | 'financeReviewStartedAt' | 'financeReviewNote' | 'financeReviewStatus' | 'financeReviewedAt' | 'financeReviewedBy' | 'financeReviewedAccount'>
