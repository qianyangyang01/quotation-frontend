...
export type QuotationRecordEditableField = 'lifecycleState' | 'financeReviewStatus' | 'status' | 'actualQuoteUsd' | 'actualQuoteCny' | 'dealQuantity' | 'closedAt' | 'note' | 'dealOptionLabel' | 'dealLines' | 'customerQuote' | 'quoteConfirmed'
...
export type QuotationRecordUpdate = Partial<Pick<QuotationRecord, Exclude<QuotationRecordEditableField, 'financeReviewStatus' | 'lifecycleState'> | 'dealOptionId'>>

const n = (value: unknown) => Number.isFinite(Number(value)) ? Number(value) : 0
const optionalN = (value: unknown) => value == null || value === '' ? null : n(value)
const editableFields: QuotationRecordEditableField[] = ['lifecycleState', 'financeReviewStatus', 'status', 'actualQuoteUsd', 'actualQuoteCny', 'dealQuantity', 'closedAt', 'note', 'dealOptionLabel', 'dealLines', 'customerQuote', 'quoteConfirmed']
...
export type QuotationReviewState = Pick<QuotationRecord, 'id' | '_version' | 'lifecycleState' | 'financeReviewStatus' | 'financeReviewedAt' | 'financeReviewedBy' | 'financeReviewedAccount'>
