...
export interface QuotationRecord {
  ...
  country: string; carrier: string; channel: string; rule: string; customerGrade: string; monthlySalesEstimate?: string
