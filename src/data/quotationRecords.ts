...
export type FinanceReviewStatus = 'pending' | 'reviewing' | 'approved' | 'rejected' | 'channel-exempt'
...
export interface ReviewAction { action:'claim'|'cancel'|'release'|'complete'; financeReviewStatus?:'approved'|'rejected'|'channel-exempt'; note?:string }
