...
export interface RecordFilters { lifecycle?: 'active' | 'archived' | 'trashed'; q?: string; product?: string; customer?: string; channel?: string; optionScale?: '' | 'single' | 'multiple'; priceDifference?: '' | 'lower' | 'equal' | 'higher' | 'missing'; status?: string; reviewStatus?: string; reviewMine?: boolean; country?: string; category?: string; startDate?: string; endDate?: string }
