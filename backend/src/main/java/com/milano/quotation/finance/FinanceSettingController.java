...
public class FinanceSettingController {
    ...
    private final FinanceSettingRepository settings; private final AuditService audit;
    public FinanceSettingController(FinanceSettingRepository settings, AuditService audit){this.settings=settings;this.audit=audit;}
